...
class Schematic(NetfileMixin):
    ...
    def __init__(self, filename=None, allow_anon=False, **kwargs):
        ...
        if filename is not None:
            # Acepta tanto un path a archivo `.sch` como un string-netlist
            # multilínea. Si tiene saltos de línea o ningún caracter de
            # ruta válido, se trata como netlist literal.
