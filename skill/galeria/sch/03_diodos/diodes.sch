# n2t-id: diodes  ·  Tipos de diodo
# n2t-tags: cpt:d, diodo, etiqueta, kind, kind:bidirectional, kind:laser, kind:led, kind:photo, kind:schottky, kind:tunnel, kind:tvs, kind:varcap, kind:zener, kind:zzener, visibilidad-nodos  ·  cpts: d  ·  src: doc/examples/schematics/diodes.sch
