# n2t-id: transistors  ·  Tipos de transistor
# n2t-tags: cpt:j, cpt:m, cpt:o, cpt:q, etiqueta, kind, kind:nfet, kind:nfetd, kind:nigfetd, kind:nigfete, kind:nigfetebulk, kind:nmos, kind:nmosd, kind:pfet, kind:pfetd, kind:pigfetd, kind:pigfete, kind:pigfetebulk, kind:pmos, kind:pmosd, transistor, visibilidad-nodos  ·  cpts: j,m,o,q  ·  src: doc/examples/schematics/transistors.sch
